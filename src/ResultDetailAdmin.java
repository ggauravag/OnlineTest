...
public class ResultDetailAdmin extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 9038951576002983234L;
	String userid = null;
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		if (session != null && session.getAttribute("adminid") != null) {
			...
			uid = AESCrypto.decrypt(req.getParameter("id").replace(' ', '+'));
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
			throws IOException {
		SendResult.send(uid, exam);
		PrintWriter out = res.getWriter();
		out.println("<script>alert('Result successfully emailed.');</script>");
		res.setHeader("Refresh",
				"0;URL=http://localhost:8080/OnlineTest/servlet/ViewResultAdmin");
	}
